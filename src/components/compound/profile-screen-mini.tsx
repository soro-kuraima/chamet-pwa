...
export function ProfileScreenMini() {
  const navigate = useNavigate();

  return (
    <div className="flex h-full flex-col justify-end rounded-lg border-2">
      <div className="flex w-full flex-col items-center justify-end rounded-t-3xl bg-white px-8 py-4">
        <div className="w-full py-2">
          <div className="user-info flex w-full items-center justify-between gap-4 py-1">
            ...
            <div className="flex flex-col items-center justify-center">
              <Button size="icon">
                <AddWhiteIcon className="h-5 w-5" />
              </Button>
              <span>Follow</span>
            </div>
          </div>
        ...
        <div className="account-stats flex w-full items-center justify-between px-4 py-2">
        ...
        <div className="action-buttons flex items-center justify-center gap-2 pt-2 md:flex-wrap">
          <Button
            variant="outline"
            onClick={() => {}}
