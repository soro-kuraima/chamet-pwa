...
export function InviteFriendsScreen() {
  ...
  return (
    <div className="invite-friends-screen relative h-screen bg-primary">
      ...
      <ScrollArea>
        <div className="flex w-2/3 items-center justify-between py-2 md:w-[55%]">
        ...
        <div className="content flex h-screen flex-col justify-between md:items-center md:justify-start">
