...
export function RecentChat() {
  return (
    <div className="recent-chat">
      <ScrollArea className="h-full w-full">
        <div className="chat-messages w-full px-4 py-6">
          <div className="message flex items-end gap-2 py-2">
            ...
            <div className="received-message rounded-2xl bg-white border border-gray-200 shadow-lg px-4 py-2">
          ...
          <div className="message">
            ...
            <div className="message">
              <div className="sent-message flex items-center justify-end gap-2 px-4 py-2">
                <div className="received-message rounded-2xl bg-primary border border-gray-200 shadow-lg px-4 py-2">
      ...
      <div id="chat-input" className="chat-input md:border-rounded-md fixed bottom-0 left-0 z-[100] w-full border-t-2 border-gray-400 bg-background p-1 drop-shadow-2xl md:left-auto md:basis-2/3">
        <ChatInput />
      </div>
    </div>
  );
