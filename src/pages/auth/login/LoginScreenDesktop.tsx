    ...
    <div>
      <div className="container relative hidden flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          <div
            className="absolute inset-0 h-[95vh] bg-secondary/30 bg-cover bg-no-repeat"
            style={{
        ...
        <div className="lg:p-8">
          <div
            className="mx-auto flex w-full flex-col items-center justify-center space-y-6 md:w-2/3 md:border-[1rem] md:border-b-0 md:border-r-0 md:border-t-0 md:border-primary md:py-16 md:pl-28 md:shadow-xl"
            style={{
