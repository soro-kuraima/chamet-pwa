  ...
  return (
    ...
    <div className="container h-full relative hidden flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="lg:p-8">
        <div
          className="mx-auto flex flex-col items-center justify-center space-y-6 md:border-[1rem] md:border-b-0 md:border-r-0 md:border-t-0 md:border-primary md:shadow-xl pl-20 pt-12 pb-10 w-4/5 xl:w-2/3"
          style={{
